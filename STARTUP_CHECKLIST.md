...
7a. **State.json metric verification (comprehensive)** — After validation, verify ALL mutable fields in state.json match reality. This step covers both per-type entries AND aggregate summaries. (Per [audit #78](https://github.com/EvaLok/schema-org-json-ld-audit/issues/78) + [audit #80](https://github.com/EvaLok/schema-org-json-ld-audit/issues/80).)
