...
function generateTsJsonLd(): Map<string, TsEntry> {
	...
	const dataset = new Dataset({
		...
		hasPart: [new Dataset({ name: 'Pacific Ocean Subset', description: 'Temperature data for the Pacific Ocean basin' })],
	});
	results.set('Dataset', {
		type: 'Dataset',
	...
	const mrp = new MerchantReturnPolicy({
		...
		returnMethod: ReturnMethodEnumeration.ReturnByMail,
		returnFees: ReturnFeesEnumeration.FreeReturn,
		returnShippingFeesAmount: new MonetaryAmount({ currency: 'USD', value: 5.99 }),
		...
		restockingFee: new MonetaryAmount({ currency: 'USD', value: 0 }),
		...
		customerRemorseReturnShippingFeesAmount: new MonetaryAmount({ currency: 'USD', value: 7.99 }),
		...
		itemDefectReturnShippingFeesAmount: new MonetaryAmount({ currency: 'USD', value: 0 }),
